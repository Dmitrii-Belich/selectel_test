<template>
  ...
  <li
    class="faq-question"
    @click="isQuestionOpened=!isQuestionOpened"
  >
    <button class="faq-question__button">
      <closed-svg v-if="isQuestionOpened" />
      <opened-svg v-else />
    </button>
    <h3
      class="faq-question__title"
      v-html="question"
    />
    <div
      v-show="isQuestionOpened"
...
.faq-question:hover .faq-question__button {
